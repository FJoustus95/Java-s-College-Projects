...
public static void imprimirSecACTOutro() {
        GameLogic.limpiarConsola();
        GameLogic.imprimirSeparador(30);
...
public static void imprimirThirdACTIntro() {
        GameLogic.limpiarConsola();
        GameLogic.imprimirSeparador(30);
...
public static void imprimirThirdACTOutro() {
        GameLogic.limpiarConsola();
        GameLogic.imprimirSeparador(30);
...
public static void imprimirFourACTIntro() {
        GameLogic.limpiarConsola();
        GameLogic.imprimirSeparador(30);
...
public static void imprimirFourACTOutro() {
        GameLogic.limpiarConsola();
        GameLogic.imprimirSeparador(30);
